...
このプロンプトは、お使いのAIによってテーマの入力方法が少し異なります。ご自身の環境に合わせて、以下のいずれかの方法をお試しください。

---

#### **【方法1】 AIと対話しながらテーマを入力する（推奨：ChatGPT, Claude,Grokなど）**

ほとんどのAIでは、こちらの方法が簡単でおすすめです。

1.  下の「プロンプト本体」を、「ここからコピー」から「ここまでコピー」まで、すべてコピーします。
2.  ChatGPT（GPT-4o以上**推奨**）、Claude（Claude 3以上**推奨**）、**Grok**（Grok4以上を**推奨**）など、お使いのAIのチャット画面に貼り付けて送信します。
3.  AIが「**分析開始(AI提案モード):** 調査テーマと、簡易版もしくは詳細版と入力」のように返信してくるのを待ちます。
4.  分析したいテーマを入力して送信します。
    *   **例1:** `日本の少子化対策 簡易版`
    *   **例2:** `トランプ政権のAIイノベーション政策の影響 詳細版`

---

#### **【方法2】 プロンプトと一緒にテーマを送信する（GrokHeavyなど）**

GrokHeavyなど、一部のAIではこちらの方法が有効です。

1.  下の「プロンプト本体」を、「ここからコピー」から「ここまでコピー」まで、すべてコピーします。
2.  お使いのAIのチャット画面に貼り付けます。
3.  **プロンプトの最後の行の下に、改行を挟んで**分析したいテーマを追記します。
    *   **入力例:**
        ```text
        ...（プロンプトの末尾）...
        ...
        日本の少子化対策 簡易版
        ```
4.  プロンプトとテーマをまとめて送信します。

---

#### **💡 分析が始まったら**

*   分析は自動で開始されます。最初は英語で出力されることがありますが、分析がすべて完了した後に**「日本語で」**と一言指示すれば、レポート全体が自然な日本語に翻訳されます。
