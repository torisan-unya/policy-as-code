...
#### **【方法1】 AIと対話しながらテーマを入力する（ほとんどのAIで推奨）**

ChatGPT、Claude、Grokなど、ほとんどのAIではこちらの方法が簡単でおすすめです。

1.  下の「プロンプト本体」を、「ここからコピー」から「ここまでコピー」まで、すべてコピーします。
2.  ChatGPT（GPT-4o以上推奨）、Claude（Claude 3以上推奨）、Grok（Grok4以上を推奨）など、お使いのAIのチャット画面に貼り付けて送信します。
...
#### **【方法2】 プロンプトと一緒にテーマを送信する（方法1でうまくいかない場合）**

方法1を試してもうまく応答が返ってこない場合や、GrokHeavyなどマルチモーダルAIではこちらの方法が有効です。

1.  下の「プロンプト本体」を、「ここからコピー」から「ここまでコピー」まで、すべてコピーします。
2.  お使いのAIのチャット画面に貼り付けます。
3.  プロンプトの最後の行の下に、改行を挟んで分析したいテーマを追記します。
    *   **入力例:**
        ```text
        ...（プロンプトの末尾）...
